...
class ClientUserOrderScreen extends StatefulWidget {
  final int pathId;

  ClientUserOrderScreen(this.pathId);

  @override
  _ClientUserOrderScreenState createState() => _ClientUserOrderScreenState();
}

class _ClientUserOrderScreenState extends State<ClientUserOrderScreen> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        centerTitle: true,
        title: Text(
          AppLocalizations.of(context).translate( widget.pathId == 2
              ? 'my_orders'
              : 'order_client'),
          ...
          builder: (context, model, child) => LayoutBuilder(builder:
            ...
            return model.state == ViewState.Busy
              ...
              child: CircularProgressIndicator(
                ...
                : model.clientUserOrdersResponse != null
                ? Column(
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: Container(
                        width: MediaQuery.of(context).size.width,
                        child: Text(model
                            .clientUserOrdersResponse.data.length
                            .toString() +
                            AppLocalizations.of(context)
                                .translate('items'))),
                  ),
                              ...
                              child: Card(
                                child: ListTile(
                                  title: Text(AppLocalizations.of(
                                      ...
                                      .translate('order') +
                                      ' ' +
                                      model.clientUserOrdersResponse.data
                                          [index].id
                                          .toString()),
                                  subtitle: Row(
                                    children: [
