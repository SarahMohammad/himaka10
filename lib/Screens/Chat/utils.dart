...
// import 'file:///home/asmaa/Desktop/himaka-main/lib/Screens/Chat/const.dart';
...
int countChatListUsers(myID, serviceProviderId, snapshot) {
  int resultInt = snapshot.data.documents.length;
// if (myID != serviceProviderId) {
// resultInt = 1;
// } else {
...
String checkValidUserData(firstName, lastName, token) {
  String returnString = '';
...
//      returnString = returnString + '\n\n';
//    }
//    returnString = returnString + 'token error';
//  }
