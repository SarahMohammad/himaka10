...
ClientUserOrdersResponse ordersResponseFromJson(String str) =>
    ClientUserOrdersResponse.fromJson(json.decode(str));


class ClientUserOrdersResponse {
  ...
  factory ClientUserOrdersResponse.fromJson(Map<String, dynamic> json) => ClientUserOrdersResponse(
    status: json["status"],
    msg: json["msg"],
...
class Order {
  ...
  factory Order.fromJson(Map<String, dynamic> json) => Order(
    ...
    subTotal: json["sub_total"]!=null?Discount.fromJson(json["sub_total"]):null,
    shippingMethod: json["shipping_method"],
    shippingCost: json["shipping_cost"]!=null?Discount.fromJson(json["shipping_cost"]):null,
    couponId: json["coupon_id"],
    discount: json["discount"]!=null?Discount.fromJson(json["discount"]):null,
    total:json["total"]!=null? Discount.fromJson(json["total"]):null,
